...
Route::get(Config::get('laravel-blog::routes.base_uri').'/'.Config::get('laravel-blog::relationship_uri_prefix').'/{relationshipIdentifier}', 'Fbf\LaravelBlog\PostsController@indexByRelationship');
